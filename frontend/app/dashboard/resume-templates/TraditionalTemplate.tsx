// Conservative, classic structure: Times-Roman serif body, centred name and
// contact header with a single rule underneath, Skills placed after
// Experience — a common conservative convention. Experience still renders
// in full reverse-chronological order with real dates.
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingBottom: 9,
    marginBottom: 13,
    borderBottom: "1pt solid #6B1F2A",
  },
  name: { fontFamily: "Times-Bold", fontSize: 20, lineHeight: 1.15, marginBottom: 7 },
  headline: { fontFamily: "Times-Italic", fontSize: 11, color: "#6B1F2A", marginBottom: 4 },
  ...
  skillsRow: { flexDirection: "row", flexWrap: "wrap", justifyContent: "center" },
...
export default function TraditionalTemplate({ data }: { data: ResumePdfData }) {
